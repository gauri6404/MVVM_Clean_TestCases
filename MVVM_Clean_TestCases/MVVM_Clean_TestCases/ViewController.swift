...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let apiConfig  = APIRequestConfigImplementation(url: "https://api.themoviedb.org/3/search/movie/", methodType: .get, headers: [:], queryParameters: ["page": "1", "query":"A", "api_key": "2696829a81b1b5827d515ff121700838", "language": "en"], bodyParameters: [:], bodyEncoding: .jsonSerializationData)
